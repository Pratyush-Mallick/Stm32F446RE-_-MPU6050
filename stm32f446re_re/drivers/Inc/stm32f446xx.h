...
#define NO_PR_BITS_IMPLEMNENTED          4
/*
...
typedef struct
{
	...
	__vo uint32_t I2C_TRISE;       /*!< I2CTRISE register,                         Address offset: 0x20      */
 ...
 *  Here the registers are first set then reset otherwise
 *  the registers would always be in reset state
 */
...
/*
 * IRQ Priority Numbers of STM32F446x MCU
 * NOTE: update these macros with valid values according to your MCU
 */
...
#define I2C_CR1_PE                       0
#define I2C_CR1_NONSTRECH                7
#define I2C_CR1_START                    8
#define I2C_CR1_STOP                     9
#define I2C_CR1_ACK                     10
#define I2C_CR1_POC                     11
...
/*
 *  Macros to reset SPIx peripherals
 *  Here the registers are first Reset AND THEN LEST IN ZERO STATEthen reset otherwise
 *  the registers would always be in reset state.
 */
